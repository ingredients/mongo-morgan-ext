  ...
  return function (tokens, req, res) {
    ...
    var JSONLine = JSON.stringify({
      ...
      REQUEST: {
        ...
        'X-Http-Method-Override': tokens['req'](
          req,
          res,
      ...
      RESPONSE: {
        ...
        'Strict-Transport-Security': tokens['res'](
          req,
          res,
          'Strict-Transport-Security'
        ), //11:36
        Refresh: tokens['res'](req, res, 'Refresh'), //11:37
        'Access-Control-Allow-Origin': tokens['res'](
          req,
          res,
        ...
        'X-Content-Security-Policy': tokens['res'](
          req,
          res,
          'X-Content-Security-Policy'
        ), //11:41
        'Content-Security-Policy': tokens['res'](
          req,
          res,
          'Content-Security-Policy'
        ), //11:42
        'X-Content-Type-Options': tokens['res'](
          req,
          res,
        ...
        'Upgrade-Insecure-Requests': tokens['res'](
          req,
          res,
